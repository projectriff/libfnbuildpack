...
var RiffBuildpackContributions = []invoker.RiffBuildpackContribution{
	java.RiffBuildpackContribution,
	node.RiffBuildpackContribution,
	command.RiffBuildpackContribution,
}
